...
# Default file storage and static files storage
STORAGES = {
    "default": {
        "BACKEND": "storages.backends.s3boto3.S3Boto3Storage" if os.environ.get('AWS_ACCESS_KEY_ID') else "django.core.files.storage.FileSystemStorage",
    },
    "staticfiles": {
